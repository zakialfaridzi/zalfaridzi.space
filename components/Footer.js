  ...
  return (
    <div className="bg-[#F1F1F1] dark:bg-gray-900">
      <div className="max-w-6xl  mx-auto px-4 py-10 md:py-10">
        ...
        <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row justify-between md:items-center mt-8 font-jkt">
          <div>
            <p>&copy; zalfaridzi</p>
          </div>
          <div>
            ...
            <div className="inline-block transform hover:scale-110 transition duration-300">
              <a className="hover:bg-gray-700 dark:hover:bg-gray-700 dark:hover:text-[#FAF089] rounded-md px-2 py-1 hover:text-[#F4FDFF] font-jkt">
                zalfaridzi
              </a>
            </div>
            with ❤️
